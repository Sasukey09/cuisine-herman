> NOTE : ceci est le document de CONCEPTION initial (ce qui était envisagé), conservé pour mémoire.
> Il ne décrit PAS le système tel qu'il existe. Voir docs/architecture.md pour la réalité.
